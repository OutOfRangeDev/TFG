...
public class InputManager
{
    ...
    private readonly Dictionary<string, Keys> _keyboardBindings = DefaultBindings.GetDefaultKeyboardBindings();
    private readonly Dictionary<string, Buttons> _gamepadBindings = DefaultBindings.GetDefaultGamepadBindings();
    ...
    {
#if  DEBUG // If we are in debug mode, we check if the action exists.
